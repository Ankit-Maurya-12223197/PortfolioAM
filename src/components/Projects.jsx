                    ...
                    <div key={index} className={` flex flex-col md:flex-row ${index % 2 !== 0 ? 'md:flex-row-reverse' : ''} mb-12`}>
                        ...
                        <div className='w-full md:1/2 p-4 flex flex-col justify-center'>
                            ...
                            <div className='flex space-x-4'>
                                <a href={project.link.site} target="_blank" className='px-4 py-2 bg-slate-600 text-gray-200 rounded-lg hover:bg-slate-700 transition duraion-300'>View site</a>
                                <a href={project.link.github} target="_blank" className='px-4 py-2 bg-slate-700 text-xl text-gray-200 rounded-lg hover:bg-slate-800 transition duraion-300'> <AiFillGithub /> </a>
                            </div>
