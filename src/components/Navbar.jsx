            ...
            <div className='max-w-[1300px] mx-auto flex justify-between text-gray-100 text-xl items-center px-12 h-20'>
                ...
                >
                    <ul className='font-semibold text-4xl space-y-8 mt-24 text-center cursor-pointer'>
                        <li><Link to='home' onClick={closeNav} smooth={true} offset={-100} duration={500}>Home</Link></li>
                        <li><Link to='skills' onClick={closeNav} smooth={true} offset={-100} duration={500}>Skills</Link></li>
                        <li><Link to='projects' onClick={closeNav} smooth={true} offset={-100} duration={500}>Projects</Link></li>
